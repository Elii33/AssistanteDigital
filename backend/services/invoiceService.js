/**
 * ============================================================================
 * Elilouche Assistante Digitale - Service Factures PDF
 * ============================================================================
 *
...
async function generateInvoicePDF(invoiceData) {
  return new Promise((resolve, reject) => {
    ...
    doc.font('Helvetica')
       ...
       .text(`Tél: ${ENTREPRISE_CONFIG.telephone}`, 50, 237);
    ...
    doc.fillColor('#374151')
       ...
       .text('QTÉ', 320, tableTop + 10, { width: 50, align: 'center' })
    ...
    doc.fillColor('#92400e')
       ...
       .text(`${totalHT.toFixed(2)} €`, 360, yPosition + 5, { width: 175, align: 'right' });
    ...
    doc.font('Helvetica-Bold')
       ...
       .text(`${totalHT.toFixed(2)} €`, 360, yPosition + 45, { width: 175, align: 'right' });
    ...
    doc.fillColor('#6b7280')
       .font('Helvetica')
       .fontSize(8)
       .text('MENTIONS LÉGALES', 60, footerY + 10)
       .text(ENTREPRISE_CONFIG.mentionTVA, 60, footerY + 25)
       .text('Conditions de paiement : Paiement à réception', 60, footerY + 40)
       .text('En cas de retard de paiement, une pénalité de 3 fois le taux d\'intérêt légal sera appliquée,', 60, footerY + 55)
       .text('ainsi qu\'une indemnité forfaitaire de 40€ pour frais de recouvrement.', 60, footerY + 67);
